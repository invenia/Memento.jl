...
julia> log("info", "use `log(mode, msg, args)` for user-defined modes, or to be verbose.")
2013-12-12T23:58:56 UTC - info:"use `log(mode, msg, args)` for user-defined modes, or to be verbose."
```
